...
<template>
    ...
    <AdminLayout>
        <div class="space-y-4">
            <div>
                <h1 class="text-2xl font-semibold">{{ $t("admin_dashboard.title") }}</h1>
                <p class="mt-1 text-sm text-slate-600">
                    Daily operational view across orders, production, inventory,
                    procurement, quality, and documents.
                </p>
            </div>
