 ...
 * @property {CustomerOrderItemInput[]} modelValue A szerkesztett tételsorok.
 ...
 * @property {(event: 'update:modelValue', value: CustomerOrderItemInput[]) => void} updateModelValue A tételsorok módosítási eseménye.
 */
/** @type {Emits} */
...
const updateRow = (index, key, value) => {
    ...
    const selectedItem =
        key === "item_id"
            ? props.itemOptions.find((item) => item.id === value)
            : null;
