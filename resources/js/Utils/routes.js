...
export const routes = {
    ...
    'admin.capacity.schedule': '/admin/capacity/schedule',
    'admin.capacity.schedule.store': '/admin/capacity/schedule',
    'admin.capacity.simulate': '/admin/capacity/simulate',
    'admin.capacity.simulate.run': '/admin/capacity/simulate',
    ...
    'admin.intelligence.bottlenecks': '/admin/intelligence/bottlenecks',
    'admin.intelligence.material-forecast': '/admin/intelligence/material-forecast',
    'admin.intelligence.supplier-performance': '/admin/intelligence/supplier-performance',
    'admin.intelligence.quality-trends': '/admin/intelligence/quality-trends',
    'admin.intelligence.risks': '/admin/intelligence/risks',
    ...
    'admin.item-suppliers.index': '/admin/item-suppliers',
    'admin.item-suppliers.store': '/admin/item-suppliers',
    'admin.item-suppliers.update': '/admin/item-suppliers/{itemSupplier}',
    'admin.item-suppliers.destroy': '/admin/item-suppliers/{itemSupplier}',
    'admin.supply-proposals.index': '/admin/supply-proposals',
    'admin.supply-proposals.store': '/admin/supply-proposals',
    'admin.supply-proposals.update': '/admin/supply-proposals/{supplyProposal}',
    'admin.supply-proposals.propose': '/admin/supply-proposals/{supplyProposal}/propose',
    'admin.supply-proposals.approve': '/admin/supply-proposals/{supplyProposal}/approve',
    'admin.supply-proposals.reject': '/admin/supply-proposals/{supplyProposal}/reject',
    'admin.supply-proposals.cancel': '/admin/supply-proposals/{supplyProposal}/cancel',
    ...
    'admin.purchase-requisitions.select-supplier':
        '/admin/purchase-requisitions/{purchaseRequisition}/supplier',
    'admin.purchase-requisitions.calculate-replenishment':
        '/admin/purchase-requisitions/{purchaseRequisition}/replenishment',
