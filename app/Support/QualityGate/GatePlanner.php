...
final class GatePlanner
{
    ...
    public function integration(?SelectionResult $selection = null): GatePlan
    {
        ...
        $commands = [
            ...
            $this->command('frontend-full', 'Frontend regression', ['npm', 'run', 'test:frontend', '--', '--maxWorkers=1'], 'frontend'),
    ...
    public function full(?SelectionResult $selection = null): GatePlan
    {
        ...
        $commands = [
            ...
            $this->command('frontend-coverage', 'Frontend suite with coverage', ['npm', 'run', 'test:frontend:coverage', '--', '--maxWorkers=1'], 'frontend'),
            $this->command('i18n', 'Translation synchronization', ['npm', 'run', 'i18n:check']),
