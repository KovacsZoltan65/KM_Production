...
use App\Policies\ItemSupplierPolicy;
...
use App\Policies\SupplyProposalPolicy;
use App\Repositories\Admin\BomRepository;
use App\Repositories\Admin\CapacityRepository;
...
use App\Repositories\Admin\ManufacturingIntelligenceRepository;
use App\Repositories\Admin\MaterialRequirementNettingRepository;
use App\Repositories\Admin\MaterialRequirementPegRepository;
...
use App\Repositories\Admin\PurchaseOrderDispatchRepository;
...
use App\Repositories\Admin\SupplierAcknowledgementRepository;
use App\Repositories\Admin\SupplierAdminRepository;
use App\Repositories\Admin\SupplyProposalRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ManufacturingIntelligenceRepositoryInterface::class, ManufacturingIntelligenceRepository::class);
        $this->app->bind(ProfessionalRoleRepositoryInterface::class, ProfessionalRoleRepository::class);
        $this->app->bind(ItemRepositoryInterface::class, ItemRepository::class);
        $this->app->bind(ItemSupplierRepositoryInterface::class, ItemSupplierRepository::class);
        $this->app->bind(SupplyProposalRepositoryInterface::class, SupplyProposalRepository::class);
        ...
        $this->app->bind(ProductionTaskRepositoryInterface::class, ProductionTaskRepository::class);
        ...
        $this->app->bind(MaterialRequirementNettingRepositoryInterface::class, MaterialRequirementNettingRepository::class);
        $this->app->bind(MaterialRequirementPegRepositoryInterface::class, MaterialRequirementPegRepository::class);
        $this->app->bind(PurchaseRequisitionRepositoryInterface::class, PurchaseRequisitionRepository::class);
        $this->app->bind(PurchaseOrderRepositoryInterface::class, PurchaseOrderRepository::class);
        $this->app->bind(PurchaseOrderDispatchRepositoryInterface::class, PurchaseOrderDispatchRepository::class);
        $this->app->bind(SupplierAcknowledgementRepositoryInterface::class, SupplierAcknowledgementRepository::class);
    ...
    public function boot(): void
    {
        ...
        Gate::policy(ItemSupplier::class, ItemSupplierPolicy::class);
        Gate::policy(SupplyProposal::class, SupplyProposalPolicy::class);
