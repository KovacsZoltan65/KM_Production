...
class SupplierPerformanceService
{
    ...
    {
        return Cache::remember(BusinessCacheKey::make(BusinessCacheDomain::IntelligenceSupplierPerformance, 'analysis'), now()->addMinutes(5), fn (): array => $this->repository->supplierPerformance());
    }
}
